...
class MoodBarChart extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => MoodBarChartState();
}

class MoodBarChartState extends State<MoodBarChart> {
  final Color barBackgroundColor = const Color(0xFFFFFEC8);
